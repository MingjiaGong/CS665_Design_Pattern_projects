 ...
 * Date: 04/15/2023
 * File Name: Star.java
 * Description: This is a concrete class that extends the Shape class and represents a Star shape object.
 * It inherits properties and methods from the Shape class, such as color, type, size, and transparency,
 * and also provides its own constructors for creating Star objects with different property values.
 */
public class Star extends Shape{
   ...
   * It takes a Shape object as a parameter and sets the Star object's property values based on the values of the Shape object.
