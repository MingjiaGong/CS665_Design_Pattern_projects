 ...
 * Description: This is a concrete class that extends the Shape class and represents a circle shape object.
 * It inherits properties and methods from the Shape class, such as color, type, size, and transparency,
 * and also provides its own constructors for creating circle objects with different property values.
 */
public class Circle extends Shape{
   ...
   * It takes a Shape object as a parameter and sets the Circle object's property values based on the values of the Shape object.
