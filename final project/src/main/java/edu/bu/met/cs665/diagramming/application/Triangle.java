 ...
 * and represents a Triangle shape object.
 * It inherits properties and methods from the Shape class,
 * such as color, type, size, and transparency, and also provides its own constructors for
 * creating Triangle objects with different property values.
 */
public class Triangle extends Shape {
   ...
   * It takes a Shape object as a parameter and sets the Triangle object's property values
