 ...
 * and represents a heart shape object.
 ...
 * creating heart objects with different property values.
 */
public class Heart extends Shape {
   ...
   * It takes a Shape object as a parameter and sets the Heart object's property values
